...
def main():
    ...
    for line in lines:
        ...
        # Convert the parts to integers and append them to the respective lists
        if line == "":
            continue
        parts = line.split("   ")
    ...
    # initialize the total of the differences
    total_difference = 0
    for (l, r) in zip(left, right):
        # Iterate over the left and right lists simultaneously
